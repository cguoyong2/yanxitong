...
const requiredTexts = [
  ...
  ['miniapp/src/pages/banquet/create/index.vue', 'picker mode="date"', 'create page supports date picker'],
  ['miniapp/src/pages/banquet/create/index.vue', 'picker mode="time"', 'create page supports time picker'],
