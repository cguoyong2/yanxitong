...
const requiredTexts = [
  ...
  ['miniapp/src/pages/gift/pay/index.vue', '支付功能暂未开通', 'payment page still shows a clear non-launch notice'],
  ...
  ['miniapp/src/pages/gift/pay/index.vue', '还没有开通支付功能', 'payment confirmation blocks real payment before provider launch'],
  ['miniapp/src/pages/gift/pay/index.vue', 'showPaymentNotice', 'payment confirmation explains launch boundary'],
  ...
  ['miniapp/src/pages/order/plan/index.vue', '还没有开通支付功能', 'plan payment confirmation blocks real payment before launch'],
