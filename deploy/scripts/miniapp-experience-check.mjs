...
const requiredTexts = [
  ...
  ['miniapp/src/pages/home/index/index.vue', 'theme-banner', 'home banner avoids fixed wedding bitmap'],
  ['miniapp/src/pages/home/index/index.vue', 'activeDesign.value.giftLabel', 'home gift labels follow event type'],
  ['miniapp/src/pages/home/index/index.vue', 'activeDesign.offlineGiftLabel', 'home offline gift action follows event type'],
  ['miniapp/src/pages/home/index/index.vue', '--accent-shadow', 'home cards use event theme shadows'],
  ['miniapp/src/pages/home/index/index.vue', 'statusLabel(latestBanquet.status)', 'home banquet card uses real banquet status instead of hardcoded published'],
  ...
  ['miniapp/src/pages/banquet/create/index.vue', '/favor/family-books', 'create page loads selectable family favor books'],
  ['miniapp/src/pages/banquet/create/index.vue', 'favorBookScope', 'create page submits favor book scope with banquet'],
  ['miniapp/src/pages/banquet/create/index.vue', 'favorFamilyBookId', 'create page submits family book id when selected'],
  ['miniapp/src/pages/banquet/create/index.vue', 'validatePhone(true)', 'create page validates contact phone before submit'],
  ['miniapp/src/pages/banquet/create/index.vue', 'phoneBlocked', 'create page locks later fields after invalid phone validation'],
  ['miniapp/src/pages/banquet/create/index.vue', ':disabled="phoneBlocked"', 'create page disables native controls until invalid phone is corrected'],
  ['miniapp/src/pages/banquet/create/index.vue', '请先修正联系电话', 'create page explains why later fields are locked'],
  ...
  ['miniapp/src/pages/banquet/create/index.vue', 'applyModalDate', 'create page quick date choice writes back to form state'],
  ['miniapp/src/pages/banquet/create/index.vue', 'applyModalTime', 'create page quick time choice writes back to form state'],
  ...
  ['miniapp/src/pages/banquet/detail/index.vue', "openGiftPay('ONLINE_GIFT')", 'detail online gift entry opens payment boundary page even before payment launch'],
  ...
  ['miniapp/src/pages/banquet/detail/index.vue', 'background: linear-gradient(145deg, var(--accent-soft), #fff);', 'detail dashboard red slot follows event theme soft color'],
  ['miniapp/src/pages/banquet/detail/index.vue', 'publishBanquet', 'detail draft banquet can be published before sharing'],
  ['miniapp/src/pages/banquet/detail/index.vue', '/banquets/${id}/publish', 'detail publish action calls banquet publish API'],
  ['miniapp/src/pages/banquet/detail/index.vue', '发布失败，请稍后重试', 'detail publish failure has visible feedback'],
  ['miniapp/src/pages/banquet/detail/index.vue', '发送请柬', 'detail draft state shows explicit send invitation button'],
  ['miniapp/src/pages/banquet/detail/index.vue', '分享请柬', 'detail published state keeps a visible sharing entry'],
  ...
  ['miniapp/src/pages/invitation/index/index.vue', 'banquetStatusLabel', 'invitation tab uses real banquet publish status'],
  ['miniapp/src/pages/invitation/index/index.vue', "statusCode === 'DRAFT'", 'invitation tab routes draft invitation back to banquet publish flow'],
  ...
  ['miniapp/src/pages/invite/edit-basic/index.vue', 'fetchBanquetEventType', 'invitation edit page resolves real banquet event type'],
  ['miniapp/src/pages/invite/edit-basic/index.vue', '{{ activeTheme.mark }}', 'invitation edit hero mark follows event type'],
  ['miniapp/src/pages/invite/edit-basic/index.vue', '--accent-soft', 'invitation edit page uses event theme soft surfaces'],
  ['miniapp/src/pages/invite/edit-basic/index.vue', '--accent-shadow', 'invitation edit page uses event theme shadows'],
  ...
  ['miniapp/src/pages/invite/public/index.vue', 'cover-fallback', 'public invitation fallback cover follows event theme'],
  ['miniapp/src/pages/invite/public/index.vue', '--primary-dark', 'public invitation has event theme color variables'],
  ['miniapp/src/pages/invite/public/index.vue', 'defaultCover(type: string)', 'public invitation avoids fixed red fallback images'],
  ['miniapp/src/pages/invite/public/index.vue', 'giftGuideDesc', 'public invitation gift guide copy follows event type'],
  ['miniapp/src/pages/invite/public/index.vue', 'giftGuideAction', 'public invitation gift action follows event type'],
  ['miniapp/src/pages/invite/public/index.vue', 'showGiftDisabled', 'public invitation disabled payment action is explicit'],
  ['miniapp/src/pages/invite/public/index.vue', '说明页打开失败', 'public invitation disabled payment opens a visible notice page'],
  ...
  ['miniapp/src/pages/rsvp/submit/index.vue', '查看${activeTheme.value.onlineGiftLabel}说明', 'RSVP disabled payment action follows event type'],
  ...
  ['miniapp/src/pages/rsvp/submit/index.vue', '--accent-soft', 'RSVP submit page uses event theme soft surfaces'],
  ['miniapp/src/pages/rsvp/submit/index.vue', '--accent-shadow', 'RSVP submit page uses event theme shadows'],
  ...
  ['miniapp/src/pages/rsvp/stats/index.vue', 'onShow', 'RSVP stats refreshes after returning from submit flow'],
  ...
  ['miniapp/src/pages/rsvp/stats/index.vue', '--accent-soft', 'RSVP stats page uses event theme soft surfaces'],
  ['miniapp/src/pages/rsvp/stats/index.vue', '--accent-shadow', 'RSVP stats page uses event theme shadows'],
  ...
  ['miniapp/src/pages/gift/offline/index.vue', 'giftRecordLabel}保存失败', 'offline gift save feedback follows event type'],
  ...
  ['miniapp/src/pages/gift/offline/index.vue', 'highlightName', 'offline gift passes saved guest name to list'],
  ...
  ['miniapp/src/pages/gift/offline/index.vue', '--accent-soft', 'offline gift page uses event theme soft surfaces'],
  ['miniapp/src/pages/gift/offline/index.vue', '{{ activeTheme.mark }}', 'offline gift hero ornament follows event type'],
  ['miniapp/src/pages/gift/list/index.vue', 'activeTheme.giftRecordLabel', 'gift list title follows event type'],
  ['miniapp/src/pages/gift/list/index.vue', 'activeTheme.offlineGiftLabel', 'gift list cash source label follows event type'],
  ...
  ['miniapp/src/pages/gift/list/index.vue', 'highlightNoticeText', 'gift list explains latest saved record sync state'],
  ['miniapp/src/pages/gift/list/index.vue', 'highlightName', 'gift list can show latest saved guest context'],
  ...
  ['miniapp/src/pages/gift/list/index.vue', '--accent-soft', 'gift list page uses event theme soft surfaces'],
  ['miniapp/src/pages/gift/list/index.vue', 'background: var(--accent-soft)', 'gift list empty state follows event theme'],
  ['miniapp/src/pages/gift/pay/index.vue', 'activeTheme.value.onlineGiftLabel', 'payment page labels follow event type'],
  ['miniapp/src/pages/gift/pay/index.vue', 'getWechatOpenId', 'payment page resolves payer openid before real payment'],
  ['miniapp/src/pages/gift/pay/index.vue', '确认支付', 'payment page shows a payment-oriented confirmation action before provider launch'],
  ['miniapp/src/pages/gift/pay/index.vue', 'requestWechatPayment', 'payment page calls WeChat payment API through shared helper'],
  ['miniapp/src/pages/gift/pay/index.vue', '支付已提交', 'payment page gives visible feedback after WeChat payment submission'],
  ...
  ['miniapp/src/pages/gift/pay/index.vue', '--accent-soft', 'payment page uses event theme soft surfaces'],
  ['miniapp/src/pages/gift/pay/index.vue', '--accent-shadow', 'payment page uses event theme shadows'],
  ...
  ['miniapp/src/pages/gift/success/index.vue', '--accent-soft', 'payment success page uses event theme soft surfaces'],
  ['miniapp/src/pages/gift/success/index.vue', '{{ activeTheme.mark }}', 'payment success ornament follows event type'],
  ['miniapp/src/pages/favor/family/index.vue', '/favor/family-books', 'family favor page uses real family book API'],
  ['miniapp/src/pages/favor/family/index.vue', 'createDefaultBook', 'family favor page can create family book'],
  ['miniapp/src/pages/favor/family/index.vue', 'inviteMember', 'family favor page can add family members'],
  ['miniapp/src/pages/favor/family/index.vue', 'addManual', 'family favor page can add family entries'],
  ['miniapp/src/pages/favor/family/index.vue', 'selectCompareContact', 'family favor page can compare family contacts'],
  ...
  ['miniapp/src/pages/favor/index/index.vue', 'background: linear-gradient(135deg, var(--accent), var(--accent-dark));', 'favor quick received icon follows event theme'],
  ...
  ['miniapp/src/pages/favor/detail/index.vue', ':class="activeTheme.tone"', 'favor detail follows event theme tone'],
  ['miniapp/src/pages/favor/detail/index.vue', 'fetchBanquetEventType', 'favor detail can resolve event type from banquet entry'],
  ['miniapp/src/pages/favor/detail/index.vue', 'activeTheme.value.giftLabel', 'favor detail copy follows event gift wording'],
  ['miniapp/src/pages/favor/detail/index.vue', 'activeTheme.value.onlineGiftLabel', 'favor detail source label follows event type'],
  ['miniapp/src/pages/favor/detail/index.vue', '--accent-soft', 'favor detail uses event theme soft surfaces'],
  ['miniapp/src/pages/favor/family/index.vue', ':class="activeTheme.tone"', 'family favor page follows event theme tone'],
  ['miniapp/src/pages/favor/family/index.vue', '{{ activeTheme.mark }}', 'family favor hero mark follows event type'],
  ['miniapp/src/pages/favor/family/index.vue', 'activeTheme.giftLabel', 'family favor labels follow event type'],
  ['miniapp/src/pages/favor/family/index.vue', '--accent-soft', 'family favor page uses event theme soft surfaces'],
  ...
  ['miniapp/src/pages/invitation/index/index.vue', 'background: var(--accent-soft);', 'invitation empty states follow event theme soft color'],
  ...
  ['miniapp/src/pages/mine/index/index.vue', 'activeTheme.value.mark', 'mine service banquet icon follows event type'],
  ['miniapp/src/pages/mine/index/index.vue', 'activeTheme.value.giftRecordLabel', 'mine gift record service follows event type'],
  ['miniapp/src/pages/mine/index/index.vue', 'recentOrderRows', 'mine page shows visible recent plan and device order rows'],
  ['miniapp/src/pages/mine/index/index.vue', 'refreshOrderSummary', 'mine page can refresh visible order summary'],
  ['miniapp/src/pages/mine/index/index.vue', 'openRecentOrder', 'mine recent order rows open target order page'],
  ['miniapp/src/pages/mine/index/index.vue', 'highlightOrderNo=', 'mine recent order rows pass highlight order number'],
  ['miniapp/src/pages/mine/index/index.vue', '/plans/orders?banquetId=', 'mine page loads plan orders for latest banquet'],
  ['miniapp/src/pages/mine/index/index.vue', '/devices/orders?banquetId=', 'mine page loads device orders for latest banquet'],
  ...
  ['miniapp/src/pages/order/plan/index.vue', 'isHighlightedOrder', 'plan page highlights selected order from mine page'],
  ['miniapp/src/pages/order/plan/index.vue', '当前查看的订单', 'plan page labels highlighted order'],
  ['miniapp/src/pages/order/plan/index.vue', 'pendingOrderTip', 'plan page explains pending payment next step'],
  ['miniapp/src/pages/order/plan/index.vue', 'pendingOrder.value = mergedOrders.find', 'plan pending order also uses cached fallback when API list is unavailable'],
  ['miniapp/src/pages/order/plan/index.vue', 'openPaymentPanel', 'paid plan selection opens payment confirmation panel'],
  ['miniapp/src/pages/order/plan/index.vue', '/plans/orders/${order.orderNo}/payment', 'plan payment creates a unified payment order'],
  ['miniapp/src/pages/order/plan/index.vue', 'requestWechatPayment', 'plan payment calls WeChat payment API through shared helper'],
  ['miniapp/src/pages/order/plan/index.vue', 'waitForPlanActivation', 'plan payment waits for the callback to activate selected entitlements'],
  ['miniapp/src/pages/order/plan/index.vue', '正在开通版本', 'plan payment shows callback activation progress'],
  ['miniapp/src/pages/order/plan/index.vue', 'returnAfterPayment', 'successful plan payment returns to banquet management'],
  ['miniapp/src/pages/order/plan/index.vue', 'uni.navigateBack', 'plan payment returns through the existing banquet detail page'],
  ['miniapp/src/pages/order/plan/index.vue', 'payment-sheet', 'plan payment uses a visible payment interface'],
  ['miniapp/src/pages/order/plan/index.vue', '选择并支付', 'professional and premium plans use payment-oriented CTA'],
  ['miniapp/src/pages/order/plan/index.vue', 'planOrderTip', 'plan page explains each order status next step'],
  ['miniapp/src/pages/order/plan/index.vue', 'openDevice', 'paid plan order can continue to device selection when right exists'],
  ['miniapp/src/pages/order/plan/index.vue', 'cacheOrder(order)', 'plan orders remain visible if list API is unavailable'],
  ['miniapp/src/pages/order/plan/index.vue', '版本订单创建失败', 'plan order creation failure has visible feedback'],
  ['miniapp/src/pages/order/plan/index.vue', '版本支付确认失败', 'plan mock payment failure has visible feedback'],
  ['miniapp/src/pages/order/plan/index.vue', 'returnBanquetDetail', 'plan page can return to banquet management detail'],
  ['miniapp/src/pages/order/plan/index.vue', '还没有版本订单', 'plan page has clear empty state before first order'],
  ['miniapp/src/pages/order/plan/index.vue', 'scrollToPlans', 'plan empty state guides user to selectable plans'],
  ...
  ['miniapp/src/pages/order/plan/index.vue', '--accent-soft', 'plan page uses event theme soft surfaces'],
  ['miniapp/src/pages/order/plan/index.vue', '--accent-shadow', 'plan page uses event theme shadows'],
  ['miniapp/src/pages/order/plan/index.vue', 'activeTheme.value.giftRecordLabel', 'plan page rights copy follows event type'],
  ['miniapp/src/pages/order/plan/index.vue', 'activeTheme.value.offlineGiftLabel', 'plan page offline gift right follows event type'],
  ...
  ['miniapp/src/pages/device/select/index.vue', 'isHighlightedOrder', 'device page highlights selected order from mine page'],
  ['miniapp/src/pages/device/select/index.vue', '当前查看的订单', 'device page labels highlighted order'],
  ['miniapp/src/pages/device/select/index.vue', 'deviceOrderTip', 'device page explains each order status next step'],
  ['miniapp/src/pages/device/select/index.vue', '返回管理台', 'paid device order can return to banquet management'],
  ...
  ['miniapp/src/pages/device/select/index.vue', '设备订单创建失败', 'device order creation failure has visible feedback'],
  ['miniapp/src/pages/device/select/index.vue', '设备支付确认失败', 'device mock payment failure has visible feedback'],
  ['miniapp/src/pages/device/select/index.vue', '设备订单刷新失败', 'device refresh failure has visible feedback'],
  ['miniapp/src/pages/device/select/index.vue', 'waitForDevicePayment', 'device real payment waits for callback state synchronization'],
  ['miniapp/src/pages/device/select/index.vue', '支付成功，设备订单状态正在同步', 'device payment timeout has clear synchronization feedback'],
  ['miniapp/src/pages/device/select/index.vue', '待支付，请点击去支付完成微信付款', 'device unpaid order uses current real-payment guidance'],
  ...
  ['miniapp/src/pages/device/select/index.vue', '--accent-soft', 'device page uses event theme soft surfaces'],
  ['miniapp/src/pages/device/select/index.vue', '--accent-shadow', 'device page uses event theme shadows'],
  ['miniapp/src/pages/device/select/index.vue', 'activeTheme.value.giftLabel', 'device page descriptions follow event gift wording'],
  ['miniapp/src/pages/device/select/index.vue', 'activeTheme.value.blessingLabel', 'device page speaker description follows event blessing wording'],
  ...
  ['miniapp/src/pages/device/select/index.vue', 'loadBanquetSchedule', 'device rental page loads current banquet time'],
  ['miniapp/src/pages/device/select/index.vue', 'syncRentWindowWithBanquet', 'device rental page can restore its suggested banquet window'],
  ['miniapp/src/pages/device/select/index.vue', '开始时间不能晚于宴席时间', 'device rental start must cover banquet time'],
  ['miniapp/src/pages/device/select/index.vue', '结束时间不能早于宴席时间', 'device rental end must cover banquet time'],
  ...
  ['miniapp/src/pages/mine/index/index.vue', 'empty-order-actions', 'mine empty order state exposes direct order entry actions'],
  ['miniapp/src/pages/mine/index/index.vue', '开通版本', 'mine empty order state can start plan order flow'],
  ['miniapp/src/pages/mine/index/index.vue', '选择设备', 'mine empty order state can start device order flow'],
